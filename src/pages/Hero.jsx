...
const Hero = ({ colorMode }) => {
  ...
  return (
    <div className={`h-96 ${colorMode === 'dark' ? ('bg-[#141414] text-white') : ('bg-white')} md:flex justify-around items-center w-full md:px-20 px-5 md:my-10 mt-20`}>
      <div className="w-1/2 md:flex hidden ">
        <img src={Avtar} alt="err" />
      </div>

      <div className="md:w-1/2 flex flex-col gap-5 font-inika">
        <div className="md:text-4xl text-2xl  flex items-center">
        ...
        <div className="md:text-base text-xs md:px-0 pr-3">
          👋 Hey there! I'm Keshav Malik, a Software Dev 💻. I thrive in the
          world of freelancing and am open to internships and full-time roles!
        ...
        <div className="flex gap-6 md:flex-row flex-col">
          <div className="flex gap-2 items-center bg-black border-2 text-white px-4 py-2 rounded-lg hover:cursor-pointer">
            <svg
            ...
            <Link to={"mailto://kmaik0907@gmail.com"}>Get in Touch</Link>
          </div>
          <div className="flex gap-2 items-center bg-gray-200 text-black px-4 py-2 rounded-lg hover:cursor-pointer">
            ...
            <Link
              to={
                "https://drive.google.com/file/d/1rSzeCxUg-6ugiJOrqQIDlTsChgSDMfc-/view?usp=sharing"
              }
              target="_blank"
            >
              My Resume
